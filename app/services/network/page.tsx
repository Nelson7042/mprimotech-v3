...
export default function NetworkPage() {
  return (
    <ServiceTemplate
      ...
      solutions={[
        "High-performance networks with redundant failover connections",
        "Intelligent SD-WAN routing reduces connectivity costs and latency",
        "WiFi 6 provides seamless coverage throughout your facility",
        "Advanced security controls protect against network threats",
        "Proactive monitoring prevents issues before they impact business"
      ]}
      ...
      benefits={[
        "Ensure reliable network availability with automated failover",
        "Optimize bandwidth usage with intelligent traffic shaping",
      ...
      relatedServices={[
        {
          title: "Risk Analysis",
          description: "Assess network and security vulnerabilities.",
